...
using Volo.Abp.Desktop.Permissions;
...
namespace Volo.Abp.Desktop.DynamicMenu
{
        ...
        IMenuItemAppService
    {
        ...
        protected override string CreatePolicyName { get; set; } = DesktopPermissions.MenuItem.Create;
        protected override string UpdatePolicyName { get; set; } = DesktopPermissions.MenuItem.Update;
        protected override string DeletePolicyName { get; set; } = DesktopPermissions.MenuItem.Delete;
